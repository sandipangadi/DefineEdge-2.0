...
5. The local relay logs in from the allowed home connection, fetches NIFTY 5-minute history, and uploads a sanitized ZIP to the existing Render/Drive pipeline.
